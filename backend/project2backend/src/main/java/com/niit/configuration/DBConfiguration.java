...
public class DBConfiguration {
  ...
  @Bean
	public SessionFactory sessionFactory() {
		...
		Class classes[]=new Class[]{User.class,Job.class,BlogPost.class,Notification.class,Friend.class,ProfilePicture.class,Chat.class,BlogComment.class};//class objects of all entities
