...
//		//AUTHENTICATION
	...
	@RequestMapping(value="/incrementLikes/{id}",method=RequestMethod.PUT)
	public ResponseEntity<?> incrementLikes(@PathVariable("id")int id){
	...
	@RequestMapping(value="/incrementDisLikes/{id}",method=RequestMethod.PUT)
	public ResponseEntity<?> incrementDisLikes(@PathVariable("id")int id){
		
		if(blogPostDao.incDisLikes(id)) {
			return new ResponseEntity<Void>(HttpStatus.OK);
		}else {
			return new ResponseEntity("Failure", HttpStatus.NOT_FOUND);
		}
